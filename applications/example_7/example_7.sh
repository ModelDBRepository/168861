...
case $3 in
    "example_7")
	# dtf implicit=100 explicit=0.6
	echo "Explicit simulations for one axon under mechanical loading"
	OPT="g Tt 0.1 dtf ${dtf} xspan 0.02 IRE 20 NRE 1 MAXE 0.1 str 0.11195694"
